...
// Array of error messages is initialized. This allows the language of the error messages to be changed easily.
{
	...
	error_message[124] = "String must be terminated before the end of file is encountered.";		//I created this for scanner.cpp void scanner::scan_string() function b/c there was none for string and eof
	error_message[125] = "String is incomplete.";		//I created this for scanner.cpp void scanner::scan_string() function b/c there were none for an incomplete string
	error_message[126] = "The string is too long."; 		//I created this
	error_message[127] = "Integer must be terminated before the end of line is encountered.";
	error_message[128] = "Integer must be terminated before the end of file is encountered.";		//I created this 
}
